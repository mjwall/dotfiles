...
set CLASSPATH="%~dp0\..\lib\asm-3.3.jar;%~dp0\..\lib\asm-commons-3.3.jar;%~dp0\..\lib\asm-tree-3.3.jar;%~dp0\..\lib\asm-util-3.3.jar;%~dp0\..\lib\critbit-0.0.4.jar;%~dp0\..\lib\ensime_2.9.2-0.9.8.8.jar;%~dp0\..\lib\json-simple-1.1.jar;%~dp0\..\lib\lucene-core-3.5.0.jar;%~dp0\..\lib\org.eclipse.jdt.core-3.6.0.v_A58.jar;%~dp0\..\lib\org.scala-refactoring_2.9.2-SNAPSHOT-0.5.0-SNAPSHOT.jar;%~dp0\..\lib\scala-compiler.jar;%~dp0\..\lib\scala-library.jar;%~dp0\..\lib\scalariform_2.9.1-0.1.1.jar;%JAVA_HOME%\lib\tools.jar"
